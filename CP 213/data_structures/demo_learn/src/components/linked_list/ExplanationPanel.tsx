    ...
    <div style={{
      ...
      {error && (
        <div style={{ marginBottom: '10px' }}>
          <strong style={{ color: '#FF0000', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Icon name="error" size={18} color="#FF0000" />
            Error:
          </strong>
      ...
      {warning && (
        <div style={{ marginBottom: '10px' }}>
          <strong style={{ color: '#FFA500', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      {explanation && (
        <div>
          <strong style={{ color: '#2E7D32', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
